...
/*   Updated: 2025/05/17 20:28:42 by ksng             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
	...
	s[0] = 'a';
	s[1] = '\0';
	ft_printf("fake|%-10.6s||%-10i||%-10c||%-10u||%-10x||%-10X||%-10p||%-10d||%%|\n",0,c,0,c,c,c,c,str,c);
	printf("real|%-10.6s||%-10i||%-10c||%-10u||%-10x||%-10X||%-10p||%-10d||%%|\n", 0, c,0,c,c,c,c,str,c);

	ft_printf("fake|%10s||%10i||%10c||%10u||%10x||%10X||%10p||%10d||%%|\n","happy",c,s[0],c,c,c,c,0,c);
